...
export default function Nav({show,setshow}:{show:boolean,setshow:Function}){
const changeShow=()=>{
   setshow(!show)
}
...
dark:text-backcolor2  dark:text-slate-300 transition-colors dark:items-center dark:justify-center relative flex justify-between items-center h-14 w-full border-2 border-textcolor dark:border-slate-50 border-solid'>
<div className='flex-1 flex justify-center '>
<h1 >你好啊</h1>
</div>
   <nav className='hidden w-64 justify-around  md:flex'>
   <Link onClick={changeShow} className='hover:-translate-y-0.5 hover:shadow-textcolor dark:hover:shadow-backcolor2' to={'/test'}>Test</Link>
